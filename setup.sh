...
if [ ! -f $PYTHON_VENV_BIN/flask ] || [ ! -d $VENV_LIB_FOLDER/flask_mongoengine ] || [ ! -d $VENV_LIB_FOLDER/jwt ] || [ ! -d $VENV_LIB_FOLDER/flask_cors ] || [ ! -d $VENV_LIB_FOLDER/flask_socketio ]; then
